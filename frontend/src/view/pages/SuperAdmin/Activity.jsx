                                                    ...
                                                    {taskChanges.map((change, changeIndex) => (
                                                            <div key={changeIndex} className="relative pl-10 mb-8">
                                                                ...
                                                                <div className="ml-6">
                                                                    <div className="flex items-center">
                                                                        <img
                                                                            src={change.modifiedBy.profilePicture.url || defaultProfilePictureUrl}
                                                                            alt="Profile"
                                                                            className="w-8 h-8 rounded-full"
                                                                        />
                                                                        <div className="ml-3">
                                                                            <div className="text-sm md:text-base text-gray-700">
                                                                                <span className="font-medium mr-1">{change.modifiedBy.username}</span>
                                                                                <span>{change.type}</span>
                                                                                {console.log('New Assignee or Change Value:', change.newValue)}
