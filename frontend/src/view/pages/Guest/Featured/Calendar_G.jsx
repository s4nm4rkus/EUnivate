...
import Toolbar_G from '../LibraryGuest.jsx/Toolbar_G';
import CustomDayHeader_G from '../LibraryGuest.jsx/CustomDayHeader_G';
      ...
      <div className="p-6 bg-white shadow-lg rounded-lg border border-gray-200 relative">
        <div className="overflow-auto md:overflow-visible" style={{ height: '500px' }}>
          <BigCalendar
            ...
            components={{
              event: TaskEvent,
              toolbar: (props) => <Toolbar_G {...props} />,
              day: {
                header: (props) => <CustomDayHeader_G {...props} tasks={initialTasks} />,
              },
            }}
